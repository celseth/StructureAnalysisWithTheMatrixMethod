...
def calculateFixedSupportMomentAndForces(beamsObjectList):
    '''
    Calculates each beams fixed support moment and forces at both ends.
    :param beamsObjectList: A list of beam objects
    :return: A list of beam objects
    '''
    for beam in beamsObjectList:
...
def calculateBeamReactionForces(beamsObjectList, r):
    ...
    param beamsObjectList: List of beam objects
    :param beamsObjectList: Array containing resulting loads
    :param r: A list of beam objects
    :return: a list of beam objects
    '''
    for beam in beamsObjectList:
...
def plotMomentDiagram(beamsObjectList):
    '''
    Takes in moment diagram and related member variables and plots the moment diagram
    with extreme values maked in the diagrams for each beam with a distributed load.
    :param beamsObjectList: a list of beam objects
    :return: nothing
    '''
    Micro = 10 ** -6
...
def outputResultsToFile(filename, beamsObjectList, nodesObjectList, r):
    '''
    Makes a file and writes result data to it.
    :param filename: file name
    :param beamsObjectList: a list of beam objects
    :param nodesObjectList: a list of node objects
    :param r: the resulting load vector
    :return: nothing
    '''

...
# This file handles the class declaration for Nodes and Beams.
...
class Beam:
    ...
    def getGlobalOrientation(self):
        ...
        :return: Returns an angle in float format
        '''
    ...
    def makeStiffness(self, materialArray):
        '''
        Appends Youngs modulus, stiffness and yield stress to beam.
    ...
    def makeLocalStiffnessMatrix(self):
        '''
        Makes an element stiffness matrix.
        :return: nothing
        '''
...
class Node:
    ...
    def __init__(self, x, z, supportX, supportZ, supportTheta):
        ...
        :param supportX: The nodes support condition in X
        :param supportZ: The nodes support condition in Z
        :param supportTheta: The nodes rotational support condition
        '''
        # Coordinates
        self.x = x
        self.z = z
